...
typedef	struct  SelectionChange SelectionChange;
...
int   textselect2(Text*, uint*, uint*);
...
enum
{
	...
	Border = 0	/* line between rows, cols, windows */
};
...
Channel	*cselchange; /* chan(SelectionChange) */
